  ...
  return (
    <div className="mt-10 bg-white p-6 rounded-xl shadow border border-gray-200 max-w-lg mx-auto">
      ...
      <div className="mb-4">
        ...
        <select value={todo.priority} onChange={(e) => setTodo({ ...todo, priority: Number(e.target.value) })}
          className="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-m text-gray-700">
